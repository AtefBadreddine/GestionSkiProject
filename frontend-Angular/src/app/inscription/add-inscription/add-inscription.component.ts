...
addInscription()
{
  ...
  this.inscriptionService.addInscriptionAndAssignToSkierAndCours(inscription.numSemaine.toString(),this.InscForm.get('numCours').value,this.InscForm.get('numSkieurs').value).subscribe(res=>{
