...
export class UpdateCoursComponent implements OnInit {
  ...
  updateCours() {
    if (this.coursForm.valid) {
      this.cours.niveau = this.niveau.value;
      this.cours.creneau = this.creneau.value;
      this.cours.prix = this.prix.value;
      this.cours.support = this.support.value;
      this.cours.typeCours = this.typeCours.value;
